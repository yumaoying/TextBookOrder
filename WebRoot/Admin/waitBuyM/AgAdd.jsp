...
<body>
	...
	<div class="gsd">
		<div class="gsdM">
			...
			<hr/>
			<div class="gsdInfo">
                 <form action="<c:url value='/admin/AdminWaitBuyBookServlet'/>" method="post">
               <input type="hidden" name="method" value="add">
				...
				出版时间：<input type="text"  class="Wdate" name="publishtime" onFocus="WdatePicker({readOnly:true})"  size="20"  style="height:20px;margin-left: 24px;" value="${waitbuybook.publishtime }" ><br/>
				采购数量&nbsp;:<input type="text" name="plantmount" onchange="changeNum();"  value="${waitbuybook.plantmount }"><br>
				<input type="submit" value="添加到采购单" class="sub"/>
				</form>
			</div>
		</div>
	</div>
